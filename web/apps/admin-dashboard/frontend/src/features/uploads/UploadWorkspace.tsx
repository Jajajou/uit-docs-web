            ...
            <Card className="space-y-6">
                ...
                <form className="space-y-6" onSubmit={(event) => void submitDraft(event)}>
                    ...
                    <Tabs
                        value={sourceType}
                        onValueChange={(value) => {
                            setValue('sourceType', value as UploadSourceType, { shouldDirty: true, shouldTouch: true, shouldValidate: true })
                    ...
                    >
                        ...
                        <TabsContent value="file" className="space-y-3">
                            <FileDropzone
                                ...
                                onChange={(nextFiles) => {
                                    setFiles(nextFiles)
                                    setValue('fileCount', nextFiles.length, { shouldDirty: true, shouldTouch: true, shouldValidate: true })
                    ...
                    <div className="space-y-3 rounded-[1.5rem] border border-gray-200 bg-white/88 p-4 dark:border-gray-800 dark:bg-[#101a2c]">
                        ...
                        <Checkbox
                            ...
                            onChange={(event) => {
                                setValue('confirmOwnership', event.target.checked, { shouldDirty: true, shouldTouch: true, shouldValidate: true })
                        ...
                        <Checkbox
                            ...
                            onChange={(event) => {
                                setValue('confirmReviewReady', event.target.checked, { shouldDirty: true, shouldTouch: true, shouldValidate: true })
