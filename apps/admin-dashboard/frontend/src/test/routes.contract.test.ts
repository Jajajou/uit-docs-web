...
describe('route contract', () => {
    it('resolves stable route metadata', () => {
        ...
        expect(getRouteMeta('/submissions')?.shell).toBe('app')
        expect(getRouteMeta('/submissions/sub-001')?.shell).toBe('app')
        expect(getRouteMeta('/portal/submissions')?.shell).toBe('app')
        expect(getRouteMeta('/portal/submissions/sub-001')?.shell).toBe('app')
        expect(getRouteMeta('/review')?.shell).toBe('app')
        expect(getRouteMeta('/portal/review')?.shell).toBe('app')
        expect(getRouteMeta('/jobs')?.shell).toBe('app')
        expect(getRouteMeta('/portal/jobs')?.shell).toBe('app')
    ...
    it('enforces role access matrix', () => {
        ...
        expect(canAccessPath('teacher', '/submissions')).toBe(true)
        expect(canAccessPath('teacher', '/portal/submissions')).toBe(true)
        expect(canAccessPath('teacher', '/review')).toBe(false)
        expect(canAccessPath('teacher', '/portal/review')).toBe(false)
        expect(canAccessPath('teacher', '/jobs')).toBe(false)
        expect(canAccessPath('teacher', '/portal/jobs')).toBe(false)
        ...
        expect(canAccessPath('admin', '/review')).toBe(true)
        expect(canAccessPath('admin', '/portal/review')).toBe(true)
        expect(canAccessPath('admin', '/jobs')).toBe(true)
        expect(canAccessPath('admin', '/portal/jobs')).toBe(true)
        expect(canAccessPath('student', '/manager')).toBe(false)
        expect(canAccessPath('student', '/submissions')).toBe(false)
