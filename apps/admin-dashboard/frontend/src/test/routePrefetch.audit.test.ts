...
describe('route prefetch audit', () => {
    ...
    it('warms the concrete app and auth preloaders without throwing', async () => {
        ...
        await expect(prefetchRoute('/portal/library')).resolves.toBeDefined()
        await expect(prefetchRoute('/upload')).resolves.toBeDefined()
        await expect(prefetchRoute('/portal')).resolves.toBeDefined()
        await expect(prefetchRoute('/portal/upload')).resolves.toBeDefined()
        await expect(prefetchRoute('/submissions')).resolves.toBeDefined()
        await expect(prefetchRoute('/submissions/sub-001')).resolves.toBeDefined()
        await expect(prefetchRoute('/portal/submissions')).resolves.toBeDefined()
        await expect(prefetchRoute('/portal/submissions/sub-001')).resolves.toBeDefined()
        await expect(prefetchRoute('/review')).resolves.toBeDefined()
        await expect(prefetchRoute('/portal/review')).resolves.toBeDefined()
        await expect(prefetchRoute('/jobs')).resolves.toBeDefined()
        await expect(prefetchRoute('/portal/jobs')).resolves.toBeDefined()
